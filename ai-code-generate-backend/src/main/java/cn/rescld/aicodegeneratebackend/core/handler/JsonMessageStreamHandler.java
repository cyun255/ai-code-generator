...
import cn.rescld.aicodegeneratebackend.ai.message.*;
    ...
    public Flux<String> handle(Flux<String> originFlux,
        ...
        return originFlux
                ...
                .doOnComplete(() -> {
                    ...
                    chatHistoryService.addChatMessage(aiResponse, MessageTypeEnum.AI.getType(), appId, userId);

                    // 异步构造 Vue 项目
                    String projectPath = AppConstant.CODE_GEN_ROOT + "/vue_project_" + appId;
